...
def load_day_data():
    file_path_day = r'C:\Bangkit2024\Proyek-Analisis-Data_Dicoding-bayu\data\day.csv'
...
def load_hour_data():
    file_path_hour = r'C:\Bangkit2024\Proyek-Analisis-Data_Dicoding-bayu\data\hour.csv'
